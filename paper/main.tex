...
\end{itemize}
The scripts, CSV outputs, and figure-generation workflow needed to reproduce the numerical checks in this manuscript are available at \url{https://github.com/bringmetheural/minimal-shift-lugano-quotients}.

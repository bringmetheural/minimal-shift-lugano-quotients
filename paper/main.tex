...
\date{Preprint draft; May 11, 2026}
...
\end{itemize}
The scripts, CSV outputs, and figure-generation workflow needed to reproduce the numerical checks in this manuscript are available at \url{https://github.com/bringmetheural/minimal-shift-lugano-quotients}. A citable release DOI can be added after a public repository release.

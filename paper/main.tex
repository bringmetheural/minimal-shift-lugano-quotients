...
\end{itemize}
The scripts, CSV outputs, and figure-generation workflow needed to reproduce the numerical checks in this manuscript are available at \url{https://github.com/bringmetheural/minimal-shift-lugano-quotients}.  The archived release is available at \url{https://doi.org/10.5281/zenodo.20128994}.
